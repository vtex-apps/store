...
- Logging functionality to track domains missing `publisherId` configuration in VTEXAdsProvider
...
- `a11ySemanticHtmlMigration` accessibility feature flag in advanced settings to control semantic HTML migration with breaking changes

## [2.142.0] - 2025-06-12

### Added

- `ShippingOptionProvider` in `StoreWrapper`
